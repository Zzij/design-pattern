...
public class Singleton7 {
    ...
    public static void main(String[] args) {
        Singleton007 instance1 = Singleton007.getInstance();
        Singleton007 instance2 = Singleton007.getInstance();
 ...
 * 2) 静态内部类方式在Singleton类被装载时并不会立即实例化，而是在需要实例化 时，
...
class Singleton007 {
   ...
   private static class SingletonInstance{
       private static final Singleton007 INSTANCE = new Singleton007();
   }
